...
-------------
Нечеткое число описывается тройкой действительных чисел (X – e1 , X, X + e2), где x – среднее значение числа, X – e1 – минимально допустимое значение, X + e2 – максимально допустимое значение Реализовать класс для работы с нечеткими числами. Операции над числами A = (A – a1, A, A + a2) и B = (B – b1, B, B + b2) выполняются по следующим правилам:
...
1. Комплексное число представляется парой действительных чисел (a, b), где a – действительная часть, b – мнимая часть. Реализовать класс для работы с комплексными числами. Обязательно должны присутсвовать операции:
